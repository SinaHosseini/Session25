...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_2.addWidget(self.btn_add_alarm, 1, 0, 1, 1)

        self.time_edit = QTimeEdit(self.tab_2)
        self.time_edit.setObjectName(u"time_edit")
        font2 = QFont()
        font2.setPointSize(14)
        self.time_edit.setFont(font2)

        self.gridLayout_2.addWidget(self.time_edit, 1, 1, 1, 1)
